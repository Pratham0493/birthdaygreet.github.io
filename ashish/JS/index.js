...
function reveal() {
  ...
  document.getElementById("giftbox_6").style.display = "none";
  ...
  document.getElementById("giftbox_10").style.display = "none";
  /*document.getElementById("giftbox_11").style.display = "none";
  document.getElementById("giftbox_12").style.display = "none";
  document.getElementById("giftbox_13").style.display = "none";
  document.getElementById("giftbox_14").style.display = "none";
  ...
  document.querySelector('.merrywrap_2').style.backgroundColor = 'transparent';//MY CHANGES
  document.querySelector('.merrywrap_3').style.backgroundColor = 'transparent';//MY CHANGES
  document.querySelector('.merrywrap_4').style.backgroundColor = 'transparent';
  document.querySelector('.merrywrap_5').style.backgroundColor = 'transparent';
  document.querySelector('.merrywrap_6').style.backgroundColor = 'transparent';
  document.querySelector('.merrywrap_7').style.backgroundColor = 'transparent';
  document.querySelector('.merrywrap_8').style.backgroundColor = 'transparent';
  document.querySelector('.merrywrap_9').style.backgroundColor = 'transparent';
  document.querySelector('.merrywrap_10').style.backgroundColor = 'transparent';
  /*document.querySelector('.merrywrap_11').style.backgroundColor = 'transparent';
  document.querySelector('.merrywrap_12').style.backgroundColor = 'transparent';
  document.querySelector('.merrywrap_13').style.backgroundColor = 'transparent';
  document.querySelector('.merrywrap_14').style.backgroundColor = 'transparent';
